...
public class IntRectangleTest
{
    ...
    {
        IntRectangle r1 = new();
        Assert.AreEqual(r1, new IntRectangle(new Vector2i(0, 0), new Vector2i(0, 0)));
        IntRectangle r2 = new(new Vector2i(1, 2), new Vector2i(3, 4));
    }

    [TestMethod]
    public void GetCollisionTest()
    {
        var rect = new IntRectangle(new Vector2i(5, 4), new Vector2i(9, 7));
    ...
    public void GetPositionsSetTest()
    {
        ...
        // #####
        // ###*#
        var rect = new IntRectangle(new Vector2i(1, 2), new Vector2i(3, 4));
        var actualSet = rect.GetPositionsSet();
        HashSet<Vector2i> posSet =
            new()
            {
                new Vector2i(1, 2),
                new Vector2i(1, 3),
    ...
    {
        var rect = new IntRectangle(new Vector2i(1, 2), new Vector2i(3, 6));
    ...
    public void GetOutlinePositionsSetTest()
    {
        ...
        // #####
        // ####*
        var rect = new IntRectangle(new Vector2i(1, 0), new Vector2i(4, 3));
        var actualSet = rect.GetOutlinePositionsSet();
        HashSet<Vector2i> outlineset =
            new()
            {
                new Vector2i(1, 0),
                new Vector2i(2, 0),
